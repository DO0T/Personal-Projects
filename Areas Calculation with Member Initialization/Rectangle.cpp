...
*							Rectangle::setLength
*																					
*		If the argument passed to the setLength function is zero or greater,																		
*		it is copied into the member variable length, and true is returned.																		
*		If the argument is negative, the value of length remains unchanged
...
*							Rectangle::setWidth
*
*		If the argument passed to the setWidth function is zero or greater,
*		it is copied into the member variable width, and true is returned.
*		If the argument is negative, the value of width remains unchanged
*		and false is returned.
*
****************************************************************************/
